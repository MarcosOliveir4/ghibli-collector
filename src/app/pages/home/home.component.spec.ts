...
describe('HomeComponent', () => {
  ...
  it('should call getFilms on ngOnInit', async () => {
    const { fixture } = await sut();
    fixture.componentInstance.ngOnInit();
    expect(ghibliApiServiceMock.getFilms).toHaveBeenCalled();
  });

  it('should fetch films on getFilms', async () => {
    const { fixture } = await sut();
    fixture.componentInstance.getFilms();
    expect(fixture.componentInstance.ghibliFilms).toEqual(mockFilms);
    expect(fixture.componentInstance.loadingGhibliFilms).toBe(false);
  });
